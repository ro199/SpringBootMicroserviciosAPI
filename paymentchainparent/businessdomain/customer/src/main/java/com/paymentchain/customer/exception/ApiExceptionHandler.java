...
/**
 *
 * @author ro199 Standard http communication have five levels of response codes
 ...
 * for awaiting response 200-level (Success) — Server completed the request as
 * expected 300-level (Redirection) — Client needs to perform further actions to
 * complete the request 400-level (Client error) — Client sent an invalid
 * request 500-level (Server error) — Server failed to fulfill a valid request
 * due to an error with server
 *
